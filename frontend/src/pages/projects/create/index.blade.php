      ...
      <form class="form form form-js" action="">
         <ul class="form--fields">
            <li class="form--field">
               ...
               <input class="form--inp form-control form-control--inp" name="name" id="p-name" required>
            </li>
            <li class="form--field">
            ...
            <li class="form--field">
               ...
               <input class="form--inp form-control form-control--inp" name="start_at" id="p-start-at" type="date">
            </li>
            <li class="form--field">
               <label class="form--label form-label" for="p-end-at">End Date</label>
               <input class="form--inp form-control form-control--inp" name="end_at" id="p-end-at" type="date">
            </li>
            <li class="form--field">
